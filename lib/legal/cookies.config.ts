...
export const COOKIE_REGISTRY: CookieRegistry = {
  essential: [
    ...
    {
      name: 'tf_debug_open',
      purpose: 'Stores whether the on-page debugger should reopen after reloads.',
      duration: 'Persistent',
      provider: 'TravelFlow',
      storage: 'localStorage',
      notes: 'Debug-only key.',
    ...
    {
      name: 'tf_debug_active_tab',
      purpose: 'Stores the last selected on-page debugger tab so reloads return to the same workspace.',
      duration: 'Persistent',
      provider: 'TravelFlow',
      storage: 'localStorage',
      notes: 'Debug-only key.',
    ...
    {
      name: 'tf_debug_map_runtime_section_expanded',
      purpose: 'Stores debugger map runtime diagnostics section expansion state.',
      duration: 'Persistent',
      provider: 'TravelFlow',
      storage: 'localStorage',
      notes: 'Debug-only key.',
    ...
    {
      name: 'tf_debug_map_runtime_override_v1',
      purpose: 'Stores the admin-only map runtime override for provider testing across app and edge map surfaces.',
      duration: 'Session',
      provider: 'TravelFlow',
      storage: 'cookie',
      notes: 'Debug-only cookie so preview and OG map endpoints can use the same provider override as the interactive app.',
    },
    {
