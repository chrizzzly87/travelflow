...
const RAW_AI_MODEL_CATALOG: RawAiModelCatalogItem[] = [
    ...
    },
    {
        ...
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-5.6-luna-pro', label: 'GPT-5.6 Luna Pro', availability: 'active',
        releasedAt: '2026-07-09', isPreferred: true, estimatedCostPerQueryLabel: '~$0.03 - $0.12',
    ...
    },
    {
        ...
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-5.6-luna', label: 'GPT-5.6 Luna', availability: 'active',
        releasedAt: '2026-07-09', estimatedCostPerQueryLabel: '~$0.03 - $0.12',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        id: 'openrouter:openai/gpt-5.6-terra-pro',
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-5.6-terra-pro', label: 'GPT-5.6 Terra Pro', availability: 'active',
        releasedAt: '2026-07-09', isPreferred: true, estimatedCostPerQueryLabel: '~$0.06 - $0.24',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        id: 'openrouter:openai/gpt-5.6-terra',
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-5.6-terra', label: 'GPT-5.6 Terra', availability: 'active',
        releasedAt: '2026-07-09', estimatedCostPerQueryLabel: '~$0.06 - $0.24',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        id: 'openrouter:openai/gpt-5.6-sol-pro',
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-5.6-sol-pro', label: 'GPT-5.6 Sol Pro', availability: 'active',
        releasedAt: '2026-07-09', isPreferred: true, estimatedCostPerQueryLabel: '~$0.12 - $0.45',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
    ...
    },
    {
        ...
        provider: 'openrouter', providerLabel: 'OpenAI', providerShortName: 'OpenAI',
        model: 'openai/gpt-chat-latest', label: 'GPT Chat Latest', availability: 'active',
        releasedAt: '2026-05-05', isPreferred: true, estimatedCostPerQueryLabel: '~$0.12 - $0.45',
    ...
    },
    {
        ...
        releasedAt: '2026-05-27', isPreferred: true, estimatedCostPerQueryLabel: '~$0.24 - $0.80',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        id: 'openrouter:anthropic/claude-opus-4.8',
        provider: 'openrouter', providerLabel: 'Anthropic', providerShortName: 'Anthropic',
        model: 'anthropic/claude-opus-4.8', label: 'Claude Opus 4.8', availability: 'active',
        releasedAt: '2026-05-27', isPreferred: true, estimatedCostPerQueryLabel: '~$0.12 - $0.45',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        ...
        estimatedCostPerQueryLabel: '~$0.005 - $0.02',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
        ...
        availability: 'active',
        releasedAt: '2026-03-17',
        estimatedCostPerQueryLabel: '~$0.02 - $0.07',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
    {
    ...
    },
    {
        ...
        estimatedCostPerQueryLabel: '~$0.001 - $0.008',
        costNote: 'Requires OPENROUTER_API_KEY on server. OpenRouter pricing and routing can vary by account and region.',
    },
];
