            ...
            <section className="mx-auto max-w-2xl rounded-3xl border border-border bg-card p-8 shadow-sm">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                    <Link
                        ...
                        className="inline-flex h-10 items-center rounded-md border border-accent-200 bg-card px-4 text-sm font-semibold text-accent-700 hover:bg-accent-50 dark:hover:bg-accent-400/12 dark:text-accent-200 dark:border-accent-400/30"
                    >
