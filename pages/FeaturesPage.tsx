...
export const FeaturesPage: React.FC = () => {
    ...
    return (
        <MarketingLayout>
                ...
                <div className="relative grid gap-12 lg:grid-cols-[minmax(0,1.02fr)_minmax(460px,560px)] lg:items-center">
                    <div className="max-w-3xl">
                        <div className="animate-hero-stagger" style={{ '--stagger': '0ms' } as React.CSSProperties}>
                            <h1
                                className="max-w-4xl text-balance text-5xl font-semibold text-slate-950 md:text-7xl dark:text-foreground"
                        ...
                        <div className="animate-hero-stagger" style={{ '--stagger': '80ms' } as React.CSSProperties}>
                            <p className="mt-6 max-w-2xl text-pretty text-lg leading-relaxed text-slate-600 md:text-xl dark:text-muted-foreground">
                                {t('hero.description')}
                            </p>
                        </div>
            ...
            <section className="border-t border-slate-200/80 py-16 md:py-24 dark:border-border/80">
                <div className="animate-scroll-blur-in max-w-3xl">
                    <h2 className="text-balance text-3xl font-semibold text-slate-950 md:text-5xl dark:text-foreground">
                        {t('bento.title')}
                    </h2>
                    <p className="mt-4 max-w-2xl text-pretty text-base leading-relaxed text-slate-600 md:text-lg dark:text-muted-foreground">
                        {t('bento.subtitle')}
                    </p>
                </div>
            ...
            <section className="border-t border-slate-200/80 py-16 md:py-24 dark:border-border/80">
                <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,420px)] lg:items-start">
                            ...
                            {workflowSteps.map((step, index) => {
                                ...
                                return (
                                    <article
                                        ...
                                        className="animate-scroll-fade-up rounded-[18px] border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/70 transition-transform hover:-translate-y-0.5 dark:border-border dark:bg-card"
                                        style={{ animationDelay: `${index * 90}ms` }}
                                    >
                                        <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
                                            <div className="flex items-center gap-3">
                                                <div className="flex size-11 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-accent-700 dark:border-border dark:bg-secondary dark:text-accent-300">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="mt-2 text-sm leading-relaxed text-slate-600 md:text-base dark:text-muted-foreground">
                                                    {step.description}
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <Card className="animate-scroll-scale-in overflow-hidden rounded-[18px] border-slate-200 bg-white py-0 shadow-sm shadow-slate-200/70 dark:border-border dark:bg-card">
                        <div className="relative h-56 overflow-hidden border-b border-slate-200/80 dark:border-border/80">
                            <img
                        ...
                        <CardContent className="px-6 pb-6 pt-6">
                            <p className="text-xl font-bold text-slate-950 dark:text-foreground">{workflowGlance.title}</p>
                            ...
                            <div className="mt-5 grid gap-3">
                                {workflowGlance.items.map((item) => (
                                    <div
                                        key={item}
                                        className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 dark:border-border dark:bg-secondary dark:text-foreground"
                                    >
                                        {item}
                                    </div>
                                ))}
            ...
            <section className="pb-16 md:pb-24 animate-scroll-scale-in">
                <div className="relative overflow-hidden rounded-[18px] border border-slate-200 bg-slate-50 px-8 py-14 text-center shadow-sm shadow-slate-200/70 md:px-16 md:py-20 dark:border-border dark:bg-secondary">
                    <h2
                        className="relative text-balance text-3xl font-semibold text-slate-950 md:text-5xl dark:text-foreground"
                        style={{ fontFamily: 'var(--tf-font-heading)' }}
                    >
                        {t('cta.title')}
                    </h2>
                    <p className="relative mx-auto mt-4 max-w-2xl text-pretty text-base leading-relaxed text-slate-600 md:text-lg dark:text-muted-foreground">
                        {t('cta.subtitle')}
                    </p>
                    <Link
                        to={buildPath('createTrip')}
