...
const NumberStepper: React.FC<{
    ...
    <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-border dark:bg-secondary">
        <div className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{label}</div>
        <div className="mt-2 flex items-center justify-between gap-2">
            <button
                type="button"
                onClick={() => onChange(clampNumber(value - 1, min, max))}
                disabled={value <= min}
                className="inline-flex size-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-600 transition-colors hover:border-accent-300 hover:text-accent-700 disabled:cursor-not-allowed disabled:opacity-40 dark:border-border dark:bg-card dark:text-muted-foreground dark:hover:text-accent-300"
            >
                <Minus size={14} />
            </button>
            <span className="min-w-[2ch] text-center text-sm font-semibold text-slate-800 dark:text-foreground">{value}</span>
            <button
                type="button"
                onClick={() => onChange(clampNumber(value + 1, min, max))}
                disabled={value >= max}
...
export const CreateTripClassicLabPage: React.FC<CreateTripClassicLabPageProps> = ({
    ...
    const settingsContent = (
        <div className="space-y-4">
            <div>
                <div className="text-xs font-semibold uppercase tracking-[0.13em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.optionalDetails')}</div>
                <p className="mt-1 text-sm text-slate-600 dark:text-muted-foreground">{t('traveler.settings.helper')}</p>
            </div>
            ...
            {settingsTraveler === 'solo' && (
                <div className="space-y-3">
                    <div className="grid gap-3 sm:grid-cols-2">
                        <div>
                            <label htmlFor="traveler-solo-gender" className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.gender')}</label>
                            <Select
                            ...
                            >
                                <SelectTrigger id="traveler-solo-gender" className="mt-1 w-full rounded-xl border-slate-200 bg-slate-50 text-sm dark:border-border dark:bg-secondary">
                                    {(() => {
                                        const option = getTravelerGenderOption(toTravelerGenderSelectValue(soloGender));
                                        const Icon = option.icon;
                                        return (
                                            <span className="inline-flex items-center gap-2 truncate">
                                                <Icon size={15} weight="duotone" className="text-slate-500 dark:text-muted-foreground" />
                        ...
                        <div>
                            <label className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.age')}</label>
	                            <input
	                                type="number"
                                ...
                                className="mt-1 w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm outline-none dark:border-border dark:bg-secondary"
                            />
                        </div>
                    </div>
                    <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.comfortMode')}</label>
                                ...
                                <button
                                    ...
                                    className={[
                                        ...
                                        soloComfort === value
                                            ...
                                            : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 dark:border-border dark:bg-card dark:text-muted-foreground dark:hover:border-border',
                                    ].join(' ')}
                                >
            ...
            {settingsTraveler === 'couple' && (
                <div className="space-y-3">
                    <div className="grid gap-3 sm:grid-cols-2">
                        <div>
                            <label htmlFor="traveler-couple-a-gender" className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.travelerA')}</label>
                            <Select
                            ...
                            >
                                <SelectTrigger id="traveler-couple-a-gender" className="mt-1 w-full rounded-xl border-slate-200 bg-slate-50 text-sm dark:border-border dark:bg-secondary">
                                    {(() => {
                        ...
                        <div>
                            <label htmlFor="traveler-couple-b-gender" className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.travelerB')}</label>
                            <Select
                            ...
                            >
                                <SelectTrigger id="traveler-couple-b-gender" className="mt-1 w-full rounded-xl border-slate-200 bg-slate-50 text-sm dark:border-border dark:bg-secondary">
                                    {(() => {
                    ...
                    <div>
                        <label htmlFor="traveler-couple-occasion" className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.occasion')}</label>
                        <Select
                            value={coupleOccasion}
                            onValueChange={(value) => setCoupleOccasion(value as CoupleOccasion)}
                        >
                            <SelectTrigger id="traveler-couple-occasion" className="mt-1 w-full rounded-xl border-slate-200 bg-slate-50 text-sm dark:border-border dark:bg-secondary">
                                {(() => {
            ...
            {settingsTraveler === 'friends' && (
                <div className="space-y-3">
                    ...
                    <div>
                        <label className="text-xs font-semibold uppercase tracking-[0.12em] text-slate-500 dark:text-muted-foreground">{t('traveler.settings.groupEnergy')}</label>
                        <div className="mt-1 grid gap-2 sm:grid-cols-3">
            ...
            <DialogContent className="max-w-xl rounded-2xl p-5" style={lgbtqModalStyle}>
                ...
                <DialogFooter sticky={false} className="p-0 pt-4">
                    <button
                        ...
                        className="rounded-xl bg-accent-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-accent-700 dark:bg-accent-400 dark:hover:bg-accent-500 dark:text-background"
                    >
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#eef2ff_0%,#f8fafc_50%,#ffffff_100%)] text-slate-900 dark:text-foreground">
                ...
                <main className="mx-auto w-full max-w-[1260px] px-4 pb-28 pt-8 sm:px-6 sm:pb-32 lg:px-8 lg:pb-14">
                    ...
                    <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_390px] lg:items-start">
                        <div className="space-y-5">
                            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-5 dark:border-border dark:bg-card/90">
                                ...
                                <div className="relative" ref={searchWrapperRef}>
                                    <MagnifyingGlass
                                        size={18}
                                        weight="duotone"
                                        className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-muted-foreground"
                                    />
                                    <div className="tf-ios-zoom-safe-shell rounded-xl">
                                            ...
                                            className="tf-ios-zoom-safe-field w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm text-slate-800 shadow-sm transition-shadow placeholder:text-slate-400 focus:border-accent-400 focus:outline-none focus:ring-2 focus:ring-accent-200 dark:border-border dark:bg-card dark:text-foreground dark:placeholder:text-muted-foreground"
                                        />
                                    </div>

                                    {searchOpen && (query.trim() || suggestions.length > 0) && (
                                        <div className="absolute inset-x-0 top-[calc(100%+8px)] z-50 max-h-72 overflow-y-auto rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-border dark:bg-card">
                                            {suggestions.length > 0 ? (
                                                suggestions.map((option) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className="w-full px-4 py-3 text-left transition-colors hover:bg-slate-50 dark:hover:bg-secondary"
                                                            {...(!query.trim()
                                                        ...
                                                        >
                                                            <div className="flex items-start justify-between gap-3">
                                                                <div className="min-w-0">
                                                                    <div className="truncate text-sm font-medium text-slate-800 dark:text-foreground">
                                                ...
                                                <div className="px-4 py-6 text-center text-sm text-slate-400 dark:text-muted-foreground">{t('destination.noMatches')}</div>
                                            )}
                                        </div>
                                    )}
                                </div>
                                            ...
                                            return (
                                                <span key={destination} className="group relative">
                                                    <div
                                                        ...
                                                        className={[
                                                            'inline-flex items-center gap-2 rounded-lg border bg-white px-2.5 py-1 text-sm font-medium text-slate-800 shadow-sm dark:bg-card dark:text-foreground',
                                                            isStartStop
                                                    ...
                                                    >
                                                        {routeLock && (
                                                            <span className="text-slate-400 dark:text-muted-foreground" aria-hidden="true">
                                                        ...
                                                        <button
                                                            ...
                                                            className={[
                                                                ...
                                                                isStartStop ? 'text-accent-700 dark:text-accent-300' : 'text-slate-400 hover:text-accent-600 dark:text-muted-foreground dark:hover:text-accent-300',
                                                            ].join(' ')}
                                                        ...
                                                        <button
                                                            ...
                                                            className="rounded-full text-slate-400 transition-colors hover:text-slate-700 dark:text-muted-foreground dark:hover:text-foreground"
                                                    ...
                                                    {season && (
                                                        <div className="pointer-events-none absolute left-0 top-[calc(100%+8px)] z-[80] hidden w-[280px] rounded-xl border border-gray-200 bg-white p-3 shadow-xl group-hover:block dark:border-border dark:bg-card">
                                                            <div className="text-xs font-semibold text-gray-900 dark:text-foreground">{t('destination.idealTravelTime')}</div>
                                                            {metaLabel && <div className="mt-0.5 text-[11px] text-gray-500 dark:text-muted-foreground">{metaLabel}</div>}
                                ...
                                <div className="mt-3 grid grid-cols-1 gap-2 sm:grid-cols-2">
                                    <label htmlFor="classic-round-trip-switch" className="inline-flex items-start gap-2 rounded-xl bg-transparent p-1.5 text-xs text-slate-700 sm:items-center sm:text-sm dark:text-foreground">
                                        <Switch
                                        ...
                                        />
                                        <span>
                                            <span className="block text-[13px] font-semibold leading-tight text-slate-800 sm:text-sm dark:text-foreground">{t('destination.roundTrip.title')}</span>
                                            <span className="block text-[11px] leading-tight text-slate-500 sm:text-xs dark:text-muted-foreground">{t('destination.roundTrip.description')}</span>
                                        </span>
                                    </label>

                                    <label htmlFor="classic-route-lock-switch" className={['inline-flex items-start gap-2 rounded-xl bg-transparent p-1.5 text-xs text-slate-700 sm:items-center sm:text-sm dark:text-foreground', canLockRoute ? '' : 'opacity-50'].join(' ')}>
                                        <Switch
                                        ...
                                        />
                                        <span>
                                            <span className="block text-[13px] font-semibold leading-tight text-slate-800 sm:text-sm dark:text-foreground">{t('destination.routeLock.title')}</span>
                                            <span className="block text-[11px] leading-tight text-slate-500 sm:text-xs dark:text-muted-foreground">{t('destination.routeLock.description')}</span>
                                        </span>
                                    </label>
                                </div>
                            </section>
                            ...
                            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-5 dark:border-border dark:bg-card/90">
                                ...
                                <div className="mb-3 inline-flex rounded-xl border border-slate-200 bg-white p-1 dark:border-border dark:bg-card">
                                    <button
                                        type="button"
                                        onClick={() => setDateInputMode('exact')}
                                        className={[
                                            'rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors',
                                            dateInputMode === 'exact' ? 'bg-accent-50 text-accent-800 dark:bg-accent-400/15' : 'text-slate-600 hover:text-slate-800 dark:text-muted-foreground dark:hover:text-foreground',
                                        ].join(' ')}
                                    >
                                        {t('dates.mode.exact')}
                                    </button>
                                    <button
                                        ...
                                        className={[
                                            'rounded-lg px-3 py-1.5 text-xs font-semibold transition-colors',
                                            dateInputMode === 'flex' ? 'bg-accent-50 text-accent-800 dark:bg-accent-400/15' : 'text-slate-600 hover:text-slate-800 dark:text-muted-foreground dark:hover:text-foreground',
                                        ].join(' ')}
                                    >
                                        {t('dates.mode.flex')}
                                    </button>
                                ...
                                {dateInputMode === 'exact' ? (
                                    ...
                                    <div className="grid gap-3 sm:grid-cols-2">
                                        <label className="space-y-1.5 text-sm">
                                            <span className="text-xs font-semibold uppercase tracking-[0.11em] text-slate-500 dark:text-muted-foreground">{t('dates.flexWindow.weeksLabel')}</span>
                                            <div className="inline-flex h-9 items-center gap-1 rounded-lg border border-slate-200 bg-white px-1.5 dark:border-border dark:bg-card">
                                                <button
                                                    type="button"
                                                    onClick={() => setFlexWeeks((previous) => clampNumber(previous - 1, 1, 8))}
                                                    disabled={flexWeeks <= 1}
                                                    className="inline-flex size-6 items-center justify-center rounded-md text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 disabled:cursor-not-allowed disabled:opacity-40 dark:text-muted-foreground dark:hover:bg-secondary dark:hover:text-foreground"
                                                ...
                                                >
                                                    ...
                                                    className="h-7 w-10 rounded-md border-0 bg-transparent text-center text-sm font-semibold text-slate-800 outline-none dark:text-foreground"
                                                />
                                                <button
                                                    type="button"
                                                    onClick={() => setFlexWeeks((previous) => clampNumber(previous + 1, 1, 8))}
                                        ...
                                        <div className="space-y-1.5 text-sm">
                                            <span className="text-xs font-semibold uppercase tracking-[0.11em] text-slate-500 dark:text-muted-foreground">
                                            ...
                                            >
                                                <SelectTrigger id="dates-flex-window-range" className="h-9 w-full rounded-lg border-slate-200 bg-white text-sm text-slate-800 focus:border-accent-400 focus:ring-accent-200 dark:border-border dark:bg-card dark:text-foreground">
                                ...
                                <div className="mt-3 border-t border-slate-200 pt-2 text-xs text-slate-500 dark:border-border dark:text-muted-foreground">
                                    {plannerDurationLabel}
                                </div>
                            </section>

                            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-5 dark:border-border dark:bg-card/90">
                                <div className="mb-2 inline-flex items-center gap-2 text-sm font-semibold text-slate-800 dark:text-foreground">
                                    <Info size={16} weight="duotone" className="text-accent-600 dark:text-accent-300" />
                                    {t('notes.title')}
                                </div>
                                <p className="mb-2 text-xs text-slate-500 dark:text-muted-foreground">{t('notes.hint')}</p>
	                                <textarea
                                    ...
                                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-700 outline-none placeholder:text-slate-400 focus:border-accent-400 focus:ring-2 focus:ring-accent-200 dark:border-border dark:bg-secondary dark:text-foreground dark:placeholder:text-muted-foreground"
                                />
                            </section>
                                ...
                                >
                                    <div className="min-w-0">
                                        <div className="inline-flex items-center gap-2 text-sm font-semibold text-slate-800 dark:text-foreground">
                                            <UsersThree size={18} weight="duotone" className="text-accent-600 dark:text-accent-300" />
                                            {t('traveler.title')}
                                        </div>
                                        <div className="truncate text-xs text-slate-500 dark:text-muted-foreground">{travelerPreviewSummary}</div>
                                    </div>
                                    {sectionExpanded.traveler ? <CaretUp size={16} className="text-slate-500 dark:text-muted-foreground" /> : <CaretDown size={16} className="text-slate-500 dark:text-muted-foreground" />}
                                </button>
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={[
                                                            ...
                                                            active
                                                                ? 'border-accent-400 bg-accent-50 text-accent-900 dark:bg-accent-400/15'
                                                                : 'border-slate-200 bg-slate-50 text-slate-700 hover:border-slate-300 dark:border-border dark:bg-secondary dark:text-foreground dark:hover:border-border',
                                                        ].join(' ')}
                                                    >
                                                        <button
                                                            type="button"
                                                            ...
                                                            className={[
                                                                ...
                                                                active
                                                                    ? 'border-accent-300 bg-white text-accent-700 opacity-100 dark:bg-card dark:text-accent-300'
                                                                    : 'border-slate-200 bg-white text-slate-500 opacity-0 group-hover:opacity-100 dark:border-border dark:bg-card dark:text-muted-foreground',
                                                            ].join(' ')}
                                                        >
                                                            <GearSix size={14} />
                                                        </button>
                                                        ...
                                                        <div className="mt-1 text-xs text-slate-500 dark:text-muted-foreground">{summary}</div>
                                                    </div>
                                                );
                                            })}
                                        </div>
                            ...
                            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-5 dark:border-border dark:bg-card/90">
                                ...
                                >
                                    <div className="min-w-0">
                                        <div className="inline-flex items-center gap-2 text-sm font-semibold text-slate-800 dark:text-foreground">
                                            <Sparkle size={18} weight="duotone" className="text-accent-600 dark:text-accent-300" />
                                            {t('style.title')}
                                        </div>
                                        <div className="truncate text-xs text-slate-500 dark:text-muted-foreground">{styleSummary || t('style.empty')}</div>
                                    </div>
                                    {sectionExpanded.style ? <CaretUp size={16} className="text-slate-500 dark:text-muted-foreground" /> : <CaretDown size={16} className="text-slate-500 dark:text-muted-foreground" />}
                                </button>
                            ...
                            <section className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm sm:p-5 dark:border-border dark:bg-card/90">
                                ...
                                >
                                    <div className="min-w-0">
                                        <div className="inline-flex items-center gap-2 text-sm font-semibold text-slate-800 dark:text-foreground">
                                            <Train size={18} weight="duotone" className="text-accent-600 dark:text-accent-300" />
                                            {t('transport.title')}
                                        </div>
                                        <div className="truncate text-xs text-slate-500 dark:text-muted-foreground">{transportSummary}</div>
                                    </div>
                                    {sectionExpanded.transport ? <CaretUp size={16} className="text-slate-500 dark:text-muted-foreground" /> : <CaretDown size={16} className="text-slate-500 dark:text-muted-foreground" />}
                                </button>
                        ...
                        <aside className="hidden lg:sticky lg:top-24 lg:block lg:self-start">
                            <div className="space-y-4 rounded-2xl border border-indigo-300/20 bg-gradient-to-b from-[#0d1330] via-[#090f26] to-[#060915] p-4 text-slate-100 shadow-2xl sm:p-5">
                                <div>
                                    <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-indigo-300/30 bg-white/5 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-indigo-100 dark:bg-card/5">
                                ...
                                <div ref={snapshotRouteRef} className="relative rounded-xl border border-white/15 bg-white/5 p-3 dark:bg-card/5">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="rounded-xl border border-white/15 bg-white/5 p-3 dark:bg-card/5">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <Select value={selectedAiModel.id} onValueChange={handleModelChange}>
                                            <SelectTrigger
                                                ...
                                                className="h-auto min-h-11 w-full rounded-xl border-indigo-200/45 bg-white/95 text-left text-indigo-950 hover:bg-white dark:bg-card/95 dark:hover:bg-card"
                                                                ...
                                                                <SelectItem key={`create-trip-model-pref-${model.id}`} value={model.id} textValue={`${model.label} ${model.model}`}>
                                                                    <span className="flex w-full min-w-0 items-start justify-between gap-2">
                                                                        <span className="min-w-0">
                                                                            ...
                                                                            <span className="block truncate text-[11px] text-slate-500 dark:text-muted-foreground">{model.model}</span>
                                                                        </span>
                                                                        <span className="inline-flex shrink-0 flex-wrap justify-end gap-1">
                                                                            <span className="rounded-full border border-slate-200 bg-slate-50 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-slate-600 dark:border-border dark:bg-secondary dark:text-muted-foreground">
                                ...
                                <button
                                    ...
                                    className="inline-flex w-full items-center justify-center rounded-xl bg-white px-4 py-3 text-sm font-semibold text-indigo-900 transition-colors hover:bg-indigo-50 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-card"
                ...
                >
                    <div className="mx-auto max-w-[1260px]">
                            ...
                            <div className="mb-2.5 space-y-1">
                                ...
                                <Select value={selectedAiModel.id} onValueChange={handleModelChange}>
                                    <SelectTrigger
                                        ...
                                        className="h-auto min-h-10 w-full rounded-xl border-white/20 bg-white/10 text-left text-white hover:bg-white/15 dark:bg-card/10 dark:hover:bg-card/15"
                                        {...getAnalyticsDebugAttributes('create_trip__model--select', {
                                            provider: selectedAiModel.provider,
                                            model: selectedAiModel.model,
                                            model_id: selectedAiModel.id,
                        ...
                        <div className="flex items-start gap-3.5">
                            <div className="min-w-0 flex-1 space-y-1.5">
                                ...
                                <div className="flex flex-wrap items-center gap-2">
                                    <span className="inline-flex items-center rounded-full border border-white/20 bg-white/5 px-2 py-0.5 text-[11px] font-medium text-indigo-100 dark:bg-card/5">
                            ...
                            <button
                                ...
                                onClick={handleGenerateTrip}
                                disabled={isSubmitting || !destinationComplete || isGenerationBlockedOffline || (dateInputMode === 'exact' && totalNights < 1)}
                                className="rounded-xl bg-white px-3.5 py-2.5 text-sm font-semibold text-indigo-900 shadow-sm disabled:cursor-not-allowed disabled:opacity-60 dark:bg-card"
                                {...getAnalyticsDebugAttributes('create_trip__cta--generate', {
                                    destination_count: orderedDestinations.length,
                                    date_mode: dateInputMode,
                                    source: 'mobile_footer',
                        ...
                        {mobileSnapshotExpanded && (
                            <div className="mt-2.5 grid grid-cols-2 gap-3 rounded-xl border border-white/15 bg-white/5 p-3.5 text-xs text-indigo-100 dark:bg-card/5">
                                <div>
