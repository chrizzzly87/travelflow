                ...
                <div className={`${previewPanelClassName} space-y-4`}>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <button
                                type="button"
                                className="inline-flex items-center justify-center gap-1 rounded-xl border border-border bg-card px-6 py-3 text-sm font-bold text-foreground shadow-sm transition-all hover:border-accent-300 hover:text-accent-700 hover:shadow-md"
                            >
                    ...
                    <div className="space-y-2">
                        ...
                        <button
                            type="button"
                            className="rounded-2xl bg-card px-8 py-3.5 text-base font-bold text-accent-700 shadow-lg transition-all hover:bg-accent-50 hover:scale-[1.03] hover:shadow-xl active:scale-[0.98]"
                        >
                            Primary
                        </button>
                    </div>
                    ...
                    <div className="space-y-2 rounded-xl border border-border bg-card p-3">
                        ...
                        <div className="grid gap-2 md:grid-cols-2">
                            ...
                            <button
                                ...
                                className="rounded-lg border border-rose-300 bg-card px-3 py-2 text-sm font-semibold text-foreground transition hover:bg-secondary"
                            >
