...
import { SaaSHero } from '../components/marketing/SaaSHero';
import { SaaSStickyFeatures } from '../components/marketing/SaaSStickyFeatures';
import { SaaSBentoGrid } from '../components/marketing/SaaSBentoGrid';
import { SaaSMetrics } from '../components/marketing/SaaSMetrics';
...
export const MarketingHomePage: React.FC = () => {
    ...
    return (
        <MarketingLayout>
            <SaaSHero />
            <div ref={carouselSectionRef} className="w-full bg-slate-50 border-b border-slate-100" id="examples-wrapper">
                {shouldLoadCarousel ? (
