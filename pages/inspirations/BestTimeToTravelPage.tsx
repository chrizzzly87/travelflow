        ...
        <MarketingLayout>
            <section className="pt-8 pb-8 md:pt-14 md:pb-12 animate-hero-entrance">
                ...
                <span className="flex items-center gap-1.5 rounded-full border border-accent-200 bg-accent-50 px-3.5 py-1.5 text-xs font-semibold uppercase tracking-wide text-accent-700 w-fit">
                    ...
                    {t('inspirations.subpages.bestTime.pill')}
                </span>
                <h1
                    className="mt-5 text-4xl font-black tracking-tight text-foreground md:text-6xl"
                    style={{ fontFamily: "var(--tf-font-heading)" }}
                >
                    {t('inspirations.subpages.bestTime.title')}
                </h1>
                <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
                    {t('inspirations.subpages.bestTime.description')}
                </p>
            </section>
            ...
            <section className="pb-16 md:pb-24">
                <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
                    ...
                    <p className="mt-4 text-sm text-muted-foreground">
                        {t('inspirations.subpages.bestTime.comingSoonDescription')}
                    </p>
                </div>
            </section>
        </MarketingLayout>
