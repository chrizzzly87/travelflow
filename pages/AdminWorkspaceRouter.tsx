...
const AdminTravelKnowledgePage = lazyWithRecovery('AdminTravelKnowledgePage', () => import('./AdminTravelKnowledgePage').then((module) => ({ default: module.AdminTravelKnowledgePage })));
...
export const AdminWorkspaceRouter: React.FC = () => (
    <Suspense fallback={<RouteLoadingFallback />}>
        <Routes>
            ...
            <Route path="travel-knowledge" element={<AdminTravelKnowledgePage />} />
            ...
            <Route path="component-playground" element={<AdminComponentPlaygroundPage />} />
