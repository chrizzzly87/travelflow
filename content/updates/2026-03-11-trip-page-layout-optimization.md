...
notify_in_app: true
in_app_hours: 24
summary: "Reworked the trip-page header, flattened the trip details dialog layout, stabilized map and pane resizing across mobile and desktop, and improved calendar zoom, fit, and checklist behavior."
---
...
- [x] [Improved] 🔎 Calendar zoom controls now show the current scale in compact 0.2 steps, use a steadier layout in the header controls, and let Fit size the trip from the rendered calendar instead of over-shrinking to a rough estimate.
