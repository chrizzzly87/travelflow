...
- [x] [Fixed] 🧊 Removed signed-in public-profile click blinking by treating `/u/:username` as an auth-bootstrap critical path and stabilizing public-profile resolver reload dependencies.
...
- [ ] [Internal] 📘 Added incident postmortem + runbook guidance for the anonymous-session refresh-chain failure mode on public routes.
