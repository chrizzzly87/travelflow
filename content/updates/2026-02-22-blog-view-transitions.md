...
- [x] [Improved] 🧩 First-run transitions now wait briefly for destination shared elements before snapshotting, reducing cold-start misplacement and ghost overlays.
