...
notify_in_app: false
in_app_hours: 24
summary: "Added a playful multilingual global 404 page with an animated plane-window centerpiece, direct planning CTA, contact fallback, and dedicated tracking."
---

## Changes
- [x] [New feature] 🛬 Added a global 404 page with an oversized centered "404" layout, using the animated homepage plane-window clouds as the middle zero.
