...
## Changes
- [x] [New feature] 🌍 Marketing pages now support locale-prefixed URLs for Spanish, German, French, Portuguese, Russian, and Italian while keeping English on root URLs.
...
- [x] [Improved] 🗺️ Planner/settings language support now covers EN/ES/DE/FR/PT/RU/IT while keeping `/create-trip`, `/trip/*`, and `/s/*` URL structures unchanged.
- [x] [Improved] 🗣️ Homepage copy and key page headlines are now localized across EN/ES/DE/FR/PT/RU/IT, including inspirations, updates, and share-unavailable views.
- [x] [Improved] 🍪 Cookie consent banner copy and actions are now translated for EN/ES/DE/FR/PT/RU/IT.
...
- [x] [Improved] 🔤 Mixed-language blog lists now keep page-level locale while applying explicit `lang` attributes to English cards and article content blocks.
...
- [x] [Fixed] 🧩 Language dropdown now includes Spanish and follows the requested ordering priority (EN, ES, DE, FR, PT, RU, with existing IT support retained).
...
- [ ] [Internal] 🇪🇸 Added full Spanish namespace coverage (`blog/common/features/home/legal/pages/pricing/settings/wip`) with locale-aware SEO metadata support.
- [ ] [Internal] 🇵🇹 Expanded Portuguese localization to full namespace coverage (`blog/common/features/home/legal/pages/pricing/settings/wip`) with locale-aware SEO metadata support.
