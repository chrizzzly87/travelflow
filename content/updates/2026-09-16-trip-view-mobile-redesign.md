...
version: v0.168.0
title: "A trip view built for the phone, and routes that follow real roads"
date: 2026-09-16
published_at: 2026-09-16T13:38:00Z
status: published
notify_in_app: true
in_app_hours: 24
summary: "On a phone the map fills the screen with a day-by-day panel over it, every activity has a directions button, and trip cards trace the roads you will actually drive."
---

## Changes
- [x] [New feature] 📱 On a phone the trip map now fills the screen, with your days as a row of round buttons over it — tap a day and both the map and the panel below move to it.
- [x] [New feature] 🚆 The day strip reads as your route: days in one city share a coloured line, and a change of city is its own stop showing the transport, the departure time and how long the leg takes.
...
- [x] [New feature] ↕️ Drag the day panel to size it, or use the single arrow to grow it to full screen and collapse it again — with a mouse as well as a finger.
...
- [x] [Improved] 🧭 "Fit to itinerary" frames your trip on a phone instead of zooming out to the whole world with the city names piled on top of each other.
...
- [x] [Improved] 👋 The example-trip notice sits out of the way on a phone and can be dismissed.
...
- [ ] [Internal] 🧪 Regression coverage for the day model and its strip nodes, overlapping stay ranges, arrival-time and overnight maths, hotel check-in/out, directions link building and platform detection, the mobile sheet snaps and controls placement, the disabled details panel, Mapbox realistic routes with and without a Google key, and phone-sized fit padding.
