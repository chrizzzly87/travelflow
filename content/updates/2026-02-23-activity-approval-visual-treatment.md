...
- [x] [Fixed] 🧭 Vertical calendar transfers now render two clearly separated side-elbow connector lines that extend fully to city edges and route into the transport pill from top and bottom.
