...
- [x] [Fixed] 🧭 Vertical calendar transfers now render two clearly separated side-elbow connector lines that extend fully to city edges and anchor directly into the transport pill's top and bottom edge points.
