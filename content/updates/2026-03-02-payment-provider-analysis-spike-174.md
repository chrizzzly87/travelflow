...
- [ ] [Internal] 🎨 Reworked the dedicated checkout route into a leaner three-step flow with inline auth, traveler details, main-column payment, and a cleaner mobile-first layout that keeps trip context intact.
