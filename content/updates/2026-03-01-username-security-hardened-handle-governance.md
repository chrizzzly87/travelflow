...
- [x] [Improved] 🚫 Blocked-term protection now catches banned tokens across username segments (`-`/`_` boundaries), while reducing false positives such as in-word matches.
