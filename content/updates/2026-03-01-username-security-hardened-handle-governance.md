...
notify_in_app: false
in_app_hours: 24
summary: "Expanded username hardening with 3-40 handle limits, substring denylist enforcement, and a cleaner username edit flow in profile settings."
---
...
- [x] [Improved] 🚫 Blocked-term protection now also catches banned words inside longer usernames, so offensive or impersonation substrings are denied before save.
