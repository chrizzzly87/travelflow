...
- [ ] [Internal] 🔎 Rebuilt Global Settings on the shared component set: a searchable, provider-grouped model picker with real provider logos, a multi-select for the approved OpenRouter list with a hand-typed escape hatch, and proper switches and selects instead of native controls.
