    ...
    ({ className, type, ...props }, ref) => (
        <input
            ...
            className={cn(
                ...
                'flex h-10 w-full min-w-0 rounded-md border border-border bg-card ps-3 pe-3 py-2 text-sm text-foreground shadow-sm outline-none transition-[border-color,box-shadow,color]',
                'placeholder:text-muted-foreground selection:bg-accent-100 selection:text-foreground',
