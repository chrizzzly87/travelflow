    ...
    ({ className, ...props }, ref) => (
        <CheckboxPrimitive.Root
            ...
            className={mergeClasses(
                'peer relative size-4 shrink-0 cursor-pointer rounded-[4px] border border-slate-400 bg-card shadow-sm outline-none transition-colors hover:border-slate-500 dark:shadow-none',
