    ...
    return (
        <div className={`border border-border rounded-lg overflow-visible bg-card ${className}`}>
            ...
            <div
                ...
                className="h-48 overflow-y-auto p-3 text-sm leading-relaxed text-foreground outline-none [&_h1]:mt-4 [&_h1]:mb-2 [&_h1]:border-t [&_h1]:border-border [&_h1]:pt-2 [&_h1]:text-base [&_h1]:font-black [&_h1]:tracking-tight [&_h1]:text-foreground [&_h2]:mt-4 [&_h2]:mb-2 [&_h2]:border-t [&_h2]:border-border [&_h2]:pt-2 [&_h2]:text-sm [&_h2]:font-extrabold [&_h2]:tracking-wide [&_h2]:text-foreground [&_h3]:mt-4 [&_h3]:mb-2 [&_h3]:border-t [&_h3]:border-border [&_h3]:pt-2 [&_h3]:text-sm [&_h3]:font-black [&_h3]:tracking-wide [&_h3]:text-foreground [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:my-1 [&_a]:text-accent-600 [&_a]:underline [&_strong]:font-semibold [&_strong]:text-foreground [&_input[type='checkbox']]:h-4 [&_input[type='checkbox']]:w-4 [&_input[type='checkbox']]:rounded-[4px] [&_input[type='checkbox']]:border-slate-500 [&_input[type='checkbox']]:accent-accent-600 [&_ul[data-task-list='true']]:list-none [&_ul[data-task-list='true']]:space-y-2 [&_ul[data-task-list='true']]:pl-0 [&_li[data-task-list-item='true']]:list-none [&_li[data-task-list-item='true']]:pl-0 [&_li[data-task-list-item='true']>label]:flex [&_li[data-task-list-item='true']>label]:items-start [&_li[data-task-list-item='true']>label]:gap-3 [&_li[data-task-list-item='true']>label>input[type='checkbox']]:mt-0.5 [&_div[data-heads-up-group='true']]:my-2 [&_div[data-heads-up-group='true']]:space-y-2 [&_div[data-heads-up-banner='true']]:rounded-lg [&_div[data-heads-up-banner='true']]:border [&_div[data-heads-up-banner='true']]:border-border [&_div[data-heads-up-banner='true']]:bg-secondary/85 [&_div[data-heads-up-banner='true']]:px-3 [&_div[data-heads-up-banner='true']]:py-2 [&_div[data-heads-up-banner='true']]:text-foreground"
            />
