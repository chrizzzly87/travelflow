        ...
        <div className="flex items-center">
            {onClick ? (
                <button
                    type="button"
                    onClick={onClick}
                    className="flex min-w-0 flex-1 items-center gap-2.5 px-3 py-2.5 text-start transition-colors hover:bg-white/70"
            ...
            {action && (
                <button
                    ...
                    className="me-2 inline-flex size-9 shrink-0 items-center justify-center rounded-full text-slate-500 transition-colors hover:bg-white hover:text-accent-600"
