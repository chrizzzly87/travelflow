...
export const TripMobilePlannerShell: React.FC<TripMobilePlannerShellProps> = ({
     ...
     * real height — an opening slide the traveller never asked for. Worse, the
     * planner is remounted once the map provider mounts (MapRuntimeProvider
     * re-parents its children when `enabled` flips), so the whole slide played
     * again seconds later.
     *
