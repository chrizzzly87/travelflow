...
const BASE_LINK_CLASS = 'inline-flex items-center justify-center gap-1.5 rounded-lg border font-medium '
  ...
  + 'hover:text-accent-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400 dark:hover:text-accent-200 dark:hover:text-accent-300';
