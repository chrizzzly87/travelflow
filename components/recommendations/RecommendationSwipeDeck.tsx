            ...
            <div className="flex flex-1 flex-col" onKeyDown={handleKeyDown}>
                ...
                <div className="flex shrink-0 items-center justify-center gap-5 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom))] pt-3">
                    <button
                        ...
                        className="inline-flex size-14 items-center justify-center rounded-full border-2 border-rose-200 bg-card text-rose-500 shadow-sm transition-transform hover:scale-105 active:scale-95"
                    ...
                    <button
                        ...
                        className="inline-flex size-14 items-center justify-center rounded-full border-2 border-emerald-200 bg-card text-emerald-600 shadow-sm transition-transform hover:scale-105 active:scale-95"
