...
export const LanguageSuggestionBanner: React.FC = () => {
    ...
    return (
        <div className="border-b border-cyan-200/60 bg-cyan-50/90 shadow-sm dark:border-cyan-400/20 dark:bg-cyan-400/10 dark:shadow-none dark:bg-cyan-400/12 dark:border-cyan-400/30">
            <div className="mx-auto flex w-full max-w-7xl items-start gap-2 px-5 py-2.5 sm:items-center sm:gap-3 md:px-8">
                <Translate size={16} weight="duotone" className="shrink-0 text-cyan-700 dark:text-cyan-300 dark:text-cyan-200" />
                <p className="min-w-0 flex-1 text-[11px] leading-relaxed text-cyan-900 dark:text-cyan-100 sm:text-sm dark:text-cyan-200">
                    {copy.message}
                </p>
                <button
                    type="button"
                    onClick={handleSwitch}
                    className="shrink-0 rounded-lg border border-cyan-300 bg-card px-2 py-1 text-xs font-semibold text-cyan-800 transition-colors hover:bg-cyan-100 sm:px-2.5 dark:border-cyan-400/30 dark:bg-card dark:text-cyan-200 dark:hover:bg-cyan-400/15 dark:hover:bg-cyan-400/12"
                ...
                <button
                    ...
                    className="shrink-0 rounded-lg p-1.5 text-cyan-600 transition-colors hover:bg-cyan-100 hover:text-cyan-800 dark:hover:bg-cyan-400/12 dark:hover:text-cyan-200"
