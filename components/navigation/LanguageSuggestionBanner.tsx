...
export const LanguageSuggestionBanner: React.FC = () => {
    ...
    return (
        <div className="border-b border-cyan-200/60 bg-cyan-50/90 shadow-sm dark:shadow-none dark:bg-cyan-400/12 dark:border-cyan-400/30">
            <div className="mx-auto flex w-full max-w-7xl items-start gap-2 px-5 py-2.5 sm:items-center sm:gap-3 md:px-8">
                <Translate size={16} weight="duotone" className="shrink-0 text-cyan-700 dark:text-cyan-200" />
                <p className="min-w-0 flex-1 text-[11px] leading-relaxed text-cyan-900 dark:text-cyan-100 sm:text-sm">
                    {copy.message}
                </p>
                <button
                    type="button"
