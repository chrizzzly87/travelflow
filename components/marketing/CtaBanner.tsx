        ...
        <section className="pb-16 md:pb-24 animate-scroll-scale-in lazy-cta-banner">
            <div className="relative rounded-3xl bg-gradient-to-br from-accent-600 to-accent-800 px-8 py-14 text-center md:px-16 md:py-20 overflow-hidden">
                ...
                <Link
                    ...
                    className="relative mt-8 inline-block rounded-2xl bg-card px-8 py-3.5 text-base font-bold text-accent-700 shadow-lg transition-[scale,background-color,box-shadow] duration-150 ease-out hover:scale-[1.03] hover:bg-accent-50 hover:shadow-xl active:scale-[0.96] dark:bg-card dark:text-accent-300 dark:hover:bg-accent-400/15 dark:hover:bg-accent-400/12 dark:text-accent-200"
