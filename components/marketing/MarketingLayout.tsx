...
export const MarketingLayout: React.FC<MarketingLayoutProps> = ({ children, rootClassName }) => {
    ...
    return (
        <div className={cn('min-h-screen scroll-smooth bg-slate-50 text-slate-900 dark:bg-background dark:text-foreground flex flex-col overflow-x-clip', rootClassName)}>
            <a
                href="#main-content"
