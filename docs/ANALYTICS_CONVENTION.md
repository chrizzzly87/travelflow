...
| `trip_view__workspace_view--overview` | — | `{ trip_id, source }` | `TripView.tsx` |
| `trip_view__workspace_view--schedule` | — | `{ trip_id, source }` | `TripView.tsx` |
| `trip_view__workspace--exit` | — | `{ trip_id, source }` | `TripView.tsx` |
