...
export const SettingsModal: React.FC<SettingsModalProps> = ({ isOpen, onClose, timelineView, onToggleView }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[1400] flex items-center justify-center p-4">
                            ...
                            <div className="space-y-6">
                                <div className="opacity-50 pointer-events-none">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <div className="aspect-video bg-gray-200 rounded-lg flex items-center justify-center text-xs">Positron (Current)</div>
                                        <div className="aspect-video bg-gray-800 rounded-lg flex items-center justify-center text-xs text-white">Dark Matter</div>
                                        <div className="aspect-video bg-green-100 rounded-lg flex items-center justify-center text-xs text-green-800">Satellite</div>
                                    </div>
                                    <p className="text-xs text-gray-500 mt-2">Map tile customization coming soon.</p>
                                </div>
                            </div>
                        )}
