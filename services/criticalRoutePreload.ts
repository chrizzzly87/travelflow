...
const ROUTE_IMPORTERS: Record<CriticalRouteModuleKey, () => Promise<unknown>> = {
  ...
  MarketingHomePage: () => import('../views/MarketingHomePage'),
  FeaturesPage: () => import('../views/FeaturesPage'),
  UpdatesPage: () => import('../views/UpdatesPage'),
  BlogPage: () => import('../views/BlogPage'),
  PricingPage: () => import('../views/PricingPage'),
  FaqPage: () => import('../views/FaqPage'),
  LoginPage: () => import('../views/LoginPage'),
  ContactPage: () => import('../views/ContactPage'),
  ImprintPage: () => import('../views/ImprintPage'),
  PrivacyPage: () => import('../views/PrivacyPage'),
  TermsPage: () => import('../views/TermsPage'),
  CookiesPage: () => import('../views/CookiesPage'),
  CreateTripClassicLabPage: () => import('../views/CreateTripClassicLabPage'),
  CreateTripV3Page: () => import('../views/CreateTripV3Page'),
