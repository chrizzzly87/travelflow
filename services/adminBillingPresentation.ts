...
export const adminBillingStatusClassName = (tone: AdminBillingStatusTone): string => {
    if (tone === 'accent') return 'border-accent-200 bg-accent-50 text-accent-800 dark:text-accent-300 dark:bg-accent-400/12 dark:text-accent-200 dark:border-accent-400/30';
