...
const PAGE_META: Record<string, PageDefinition> = {
  ...
  "/features": {
    title: "Every Trip, Planned In One Place",
    description: "Draft the route with AI, shape it on the map, and share one link with everyone coming.",
    pill: "FEATURES",
  },
  "/updates": {
...
const LOCALIZED_PAGE_META: Record<string, Partial<Record<SupportedLocale, LocalizedPageDefinition>>> = {
  ...
  "/features": {
    es: { title: "Cada Viaje, Planeado En Un Solo Sitio", description: "Traza la ruta con IA, dale forma en el mapa y comparte un enlace con quien venga." },
    de: { title: "Jede Reise, An Einem Ort Geplant", description: "Entwirf die Route mit KI, form sie auf der Karte und teil einen Link mit allen, die mitkommen." },
    fr: { title: "Chaque Voyage, Planifié Au Même Endroit", description: "Tracez l'itinéraire avec l'IA, ajustez-le sur la carte et partagez un lien avec tous ceux qui viennent." },
    it: { title: "Ogni Viaggio, Pianificato In Un Posto Solo", description: "Traccia il percorso con l'IA, modellalo sulla mappa e condividi un link con chi parte con te." },
    ru: { title: "Каждая поездка — в одном месте", description: "Набросайте маршрут с ИИ, поправьте его на карте и отправьте одну ссылку всем, кто едет." },
    pt: { title: "Cada Viagem, Planeada Num Só Lugar", description: "Desenhe a rota com IA, ajuste-a no mapa e partilhe um link com quem vem consigo." },
    pl: { title: "Każda Podróż Zaplanowana W Jednym Miejscu", description: "Naszkicuj trasę z AI, dopracuj ją na mapie i wyślij jeden link wszystkim, którzy jadą." },
    ko: { title: "모든 여행을 한곳에서", description: "AI로 경로를 잡고, 지도에서 다듬고, 링크 하나로 함께 가는 사람 모두와 나누세요." },
    fa: { title: "هر سفر، در یک جا", description: "مسیر را با هوش مصنوعی طرح بزن، روی نقشه شکلش بده و یک لینک با همه‌ی همسفرها به اشتراک بگذار." },
    ur: { title: "ہر سفر، ایک ہی جگہ منصوبہ بند", description: "AI سے راستہ بنائیں، نقشے پر ڈھالیں اور ایک لنک ساتھ جانے والوں سب کے ساتھ بانٹیں۔" },
  },
  "/updates": {
